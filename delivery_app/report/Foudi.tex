...
\end{figure}
		...
		\subsubsection{L'inscription} Comme la figure \ref{fig:signup} montre, le nouvel utilisateur doit choisir le type de compte (Client, Restaurant, ou Delivery). Il remplit ensuite les informations nécessaires et appuie sur "Create Account".
Le système vérifiera si l'utilisateur n'existe pas déjà et validera ensuite son compte.	
	...
	\section{Cas d'utilisateur server} Le server (employé du restaurant) dispose de trois pages dans le menu de l'application:
		\begin{itemize}
			...
			\item \textbf{Page de profile}: Pour voir les avis des client au son restaurant.
		\end{itemize}
