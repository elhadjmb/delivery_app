...
\begin{itemize}
	...
	\item Dans le deuxième chapitre, nous citons les différentes étapes suivies pour accomplir la conception de cette application on utilisant les diagrammes UML ainsi l'identification des acteurs prencipeaux qui joue des rôles dans notre application.
...
\chapter{Conception de l'application} Dans ce chapitre nous présentons les differentes étapes de la conception de l'application de gestion de commande et livraison de la restauration.
	...
	\begin{itemize}
		\item Repas (Dish): Toute nourriture qui peuvent être préparés par un restaurant et livrés par une etablissement de livraison
	...
	\begin{enumerate}
		\item Le client passe une commande et la paye via l'application.
