...
class Colour {
  static const purple = Color.fromRGBO(51, 0, 51, 99.0);
  static const black = Color(0xff001B29);
  static const white = Color(0xffF4F4F9);
  static const yellow = Color(0xffFCBF49);
